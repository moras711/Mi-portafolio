...
const translations = {
    ...
    en: {
        ...
        'h3-services2':'Web & Digital',
        'p-services2':'Wireframes y estructuras funcionales para sitios web o apps, diseño de interfaces modernas y responsivas (adaptadas a cualquier dispositivo). Creación de landing pages para campañas o lanzamientos. Optimización del diseño UX/UI centrado en la experiencia del usuario. Programación de aplicaciones web interactivas, mantenimiento y actualización de sitios web.',
        'p-descarga':'You can find my resume at <a href="#" class="download">here</a> ',
        'hero-contact':'Contact me through the form below and I will get back to you as soon as possible.<br> can.',
        'email':'Email',
        'p-email':'angempubli@gmail.com',
        'telefono':'Phone',
